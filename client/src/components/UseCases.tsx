...
export function UseCases() {
  return (
    <section id="use-cases-section" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold font-display mb-4">Use Cases</h2>
          <p className="text-lg text-muted-foreground">FreeTrust powers trust across the entire professional services spectrum.</p>
        </div>

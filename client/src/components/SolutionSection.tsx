...
const solutions = [
  ...
  },
  {
    ...
    description:
      "Capital held in neutral custody and released only upon verified milestone completion, never before.",
  ...
  },
  {
    ...
    description:
      "Automated analysis validates that deliverables meet every requirement in the original contract.",
  ...
  },
  {
    ...
    description:
      "Immutable, cryptographic record of your professional history. Impossible to fake or delete.",
  ...
  },
  {
    ...
    description:
      "Local discovery with physical verification that adds real-world accountability to every profile.",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            A comprehensive infrastructure engineered to eliminate every risk in
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {solutions.slice(0, 3).map((s, i) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-6 ${s.iconColor} group-hover:scale-110 transition-transform duration-200`}
              >
                <s.icon size={24} />
              </div>
